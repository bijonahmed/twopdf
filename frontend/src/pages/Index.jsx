                ...
                <div className="content_container">
                        ...
                        <div className="top_icon">
                          ...
                          >
                            <g
                              ...
                              fillRule="evenodd"
                            >
                              <path d="M5.488.363h31.75c1.78 0 2.43.184 3.082.535a3.66 3.66 0 0 1 1.512 1.512c.348.652.535 1.297.535 3.082v21.746c0 1.78-.187 2.43-.535 3.082a3.66 3.66 0 0 1-1.512 1.512c-.652.348-1.3.535-3.082.535H5.488c-1.78 0-2.43-.187-3.082-.535A3.66 3.66 0 0 1 .895 30.32c-.348-.652-.535-1.3-.535-3.082V5.488c0-1.78.188-2.43.535-3.082A3.71 3.71 0 0 1 2.406.895c.652-.348 1.3-.53 3.082-.53zm0 0"></path>
                              <path d="M44.563 49.69h32.816c-1.78 0-2.43-.184-3.082-.535-.645-.34-1.172-.867-1.512-1.512-.348-.652-.535-1.297-.535-3.082V22.816c0-1.78.184-2.43.535-3.082.34-.645.867-1.172 1.512-1.512.652-.348 1.3-.535 3.082-.535h31.746c1.785 0 2.43.188 3.082.535.645.34 1.172.867 1.512 1.512.352.652.535 1.3.535 3.082v21.746c0 1.785-.184 2.43-.535 3.082-.34.645-.867 1.172-1.512 1.512-.652.352-1.297.535-3.082.535zm0 0"></path>
                            </g>
                            <path
                    ...
                    <Link to="/pdf/pdftotxt">
                      <div className="box_top">
                        <div className="top_icon">
                          ...
                          >
                            <path
                              d="M32.324 15.656h-9.547c-2.477 0-3.375.258-4.28.742a5.04 5.04 0 0 0-2.098 2.102c-.484.902-.742 1.8-.742 4.277v9.547H5.18c-1.8 0-2.45-.187-3.113-.54-.648-.348-1.184-.88-1.527-1.527-.352-.66-.54-1.31-.54-3.113V5.18c0-1.8.188-2.45.54-3.113S1.4.89 2.066.54 3.38 0 5.18 0h31.965c1.8 0 2.453.188 3.113.54.648.344 1.18.88 1.527 1.527.352.66.54 1.313.54 3.113zm0 0"
                              fillRule="evenodd"
                            ...
                            />
                            <path
                              d="M22.855 17.676H44.82c1.8 0 2.45.188 3.113.543a3.68 3.68 0 0 1 1.527 1.523c.352.66.54 1.313.54 3.113V44.82c0 1.8-.187 2.45-.54 3.113s-.867 1.176-1.527 1.527-1.312.54-3.113.54h32.855c-1.8 0-2.453-.187-3.113-.54-.648-.344-1.18-.88-1.527-1.527-.352-.66-.54-1.312-.54-3.113V22.855c0-1.8.188-2.453.54-3.113.348-.648.88-1.18 1.527-1.527.66-.352 1.313-.54 3.113-.54zm0 0"
                              fillRule="evenodd"
                              fill="rgb(37.254902%,51.372549%,77.647059%)"
                            />
                            <path
                              d="M38.996 26.75h3.965l-2.94 14.64h-3.094l-1.777-9.035-1.824 9.035h39.12L26.2 26.75h3.164l1.508 9.363 1.938-9.363h3.004l1.727 9.297zm0 0"
                              fill="rgb(100%,100%,100%)"
                            />
                          </svg>
                        </div>
                      ...
                      <div className="box_top">
                        <div className="top_icon">
                          ...
                          >
                            ...
                            <g fillRule="evenodd">
                              <path
                                d="M22.855 17.676H44.82c1.8 0 2.453.188 3.113.543.648.344 1.184.875 1.527 1.527.352.656.54 1.31.54 3.11V44.82c0 1.8-.187 2.453-.54 3.113a3.69 3.69 0 0 1-1.527 1.527c-.66.352-1.312.54-3.113.54h32.855c-1.8 0-2.453-.187-3.113-.54-.648-.344-1.18-.88-1.527-1.527-.352-.66-.54-1.312-.54-3.113V22.855c0-1.8.188-2.453.54-3.113.348-.648.88-1.18 1.527-1.527.66-.352 1.313-.54 3.113-.54zm0 0"
                                fill="rgb(100%,46.27451%,31.764706%)"
                              />
                              <path
                                d="M38.367 34.648C37.28 35.55 35.828 36 34.008 36H32.39v5h39V26.5h5.313c3.79 0 5.688 1.54 5.688 4.62 0 1.453-.543 2.633-1.633 3.535zM33.82 29H32.5v4.5h1.32c1.785 0 2.68-.758 2.68-2.273 0-1.484-.89-2.227-2.68-2.227zm0 0"
                                fill="rgb(100%,100%,100%)"
                              />
                            </g>
                          </svg>
                  ...
                  <div className="content_box">
                    <Link to="/pdf/imgtopdf">
                      <div className="box_top">
                        <div className="top_icon">
                          <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 50 50"><path d="M17.676 34.344h9.55c2.477 0 3.375-.258 4.28-.742a5.04 5.04 0 0 0 2.098-2.102c.484-.902.742-1.8.742-4.277v-9.547H44.82c1.8 0 2.453.188 3.113.54s1.176.87 1.527 1.527.54 1.31.54 3.113V44.82c0 1.8-.187 2.453-.54 3.113a3.69 3.69 0 0 1-1.527 1.527c-.66.352-1.312.54-3.113.54h32.855c-1.8 0-2.453-.187-3.113-.54s-1.172-.87-1.527-1.527-.54-1.312-.54-3.113zm0 0"  fill="rgb(98.431373%,93.72549%,65.882353%)"></path><path d="M43.94 37.137c0-.477-.395-.863-.883-.863s-.883.387-.883.863v3.844l-5.145-5.047c-.348-.34-.902-.34-1.25 0a.85.85 0 0 0-.258.609.86.86 0 0 0 .258.613l5.145 5.05h-3.914c-.488 0-.883.387-.883.867s.395.867.883.867h6.05c.113-.004.227-.023.336-.07a.87.87 0 0 0 .477-.465c.05-.105.066-.22.066-.332l.004-5.934zm0 0" fill="rgb(71.764706%,62.745098%,0.392157%)"></path><g ><path d="M5.184 0h31.988c1.8 0 2.453.188 3.113.54.652.344 1.184.88 1.527 1.53.352.656.54 1.313.54 3.113v21.984c0 1.805-.187 2.457-.54 3.117-.344.648-.875 1.184-1.527 1.527-.66.352-1.312.54-3.113.54H5.184c-1.8 0-2.457-.187-3.113-.54-.652-.344-1.184-.88-1.527-1.527C.188 29.625 0 28.973 0 27.168V5.184c0-1.8.188-2.457.54-3.113.344-.652.88-1.184 1.53-1.53S3.383 0 5.184 0zm0 0" fill="rgb(83.921569%,74.901961%,17.647059%)"></path><path d="M10.28 12.945v4.688c0 1.66-.926 2.66-2.707 2.66C5.406 20.293 5 18.852 5 18.07c0-.668.31-1.098.86-1.098.648 0 .813.504.813 1.05 0 .516.242.89.88.89.594 0 .926-.44.926-1.3V12.95c0-.54.352-.898.902-.898s.902.36.902.898zm1.672 6.402v-6.102c0-.8.418-1.055 1.055-1.055h3.762c1.516 0 2.738.75 2.738 2.508 0 1.44-1 2.508-2.75 2.508h-2v2.152c0 .54-.355.902-.902.902s-.902-.363-.902-.902zm1.805-5.773v2.242h1.68c.727 0 1.266-.437 1.266-1.12 0-.793-.56-1.12-1.45-1.12zm13.285 3.1v2.984c0 .332-.254.602-.613.602-.52 0-.66-.32-.773-1.023-.516.648-1.23 1.066-2.352 1.066-2.793 0-3.863-1.926-3.863-4.145 0-2.676 1.672-4.148 4.125-4.148 2.004 0 3.07 1.2 3.07 1.902 0 .63-.46.793-.848.793-.89 0-.56-1.242-2.32-1.242-1.242 0-2.223.813-2.223 2.816 0 1.56.77 2.637 2.246 2.637.957 0 1.793-.648 1.88-1.617h34.2c-.383 0-.812-.14-.812-.69 0-.44.254-.69.703-.69h3.223c.527 0 .738.262.738.758zm0 0" fill="rgb(100%,100%,100%)"></path></g></svg>
                        </div>
                        <h3>Image to PDF</h3>
                        <p>
                    ...
                    <a href="#">
                      <div className="box_top">
                        <div className="top_icon">
                          ...
                          >
                            <path
                              d="M17.676 34.344h9.55c2.477 0 3.375-.258 4.28-.742a5.04 5.04 0 0 0 2.098-2.102c.484-.902.742-1.8.742-4.277v-9.547H44.82c1.8 0 2.453.188 3.113.54s1.176.87 1.527 1.527.54 1.31.54 3.113V44.82c0 1.8-.187 2.453-.54 3.113a3.69 3.69 0 0 1-1.527 1.527c-.66.352-1.312.54-3.113.54h32.855c-1.8 0-2.453-.187-3.113-.54s-1.172-.87-1.527-1.527-.54-1.312-.54-3.113zm0 0"
                              fillRule="evenodd"
                              fill="rgb(37.254902%,51.372549%,77.647059%)"
                            />
                            <path
                            ...
                            />
                            <path
                              d="M27.145 32.324H5.18c-1.8 0-2.453-.187-3.113-.543S.89 30.914.54 30.254 0 28.95 0 27.145V5.18c0-1.8.188-2.453.54-3.113A3.69 3.69 0 0 1 2.066.539C2.727.188 3.38 0 5.18 0h31.965c1.8 0 2.453.188 3.113.54s1.172.87 1.527 1.527.54 1.313.54 3.113v21.965c0 1.8-.187 2.453-.54 3.113s-.87 1.176-1.527 1.527-1.312.54-3.113.54zm0 0"
                              fillRule="evenodd"
                              fill="rgb(86.27451%,89.803922%,98.039216%)"
                            />
                            <path
                              d="M20.844 8.61h3.96l-2.94 14.64H17.77l-1.777-9.035-1.824 9.035h-3.203L8.04 8.61h3.164l1.508 9.363 1.938-9.363h3.004l.04.203 1.688 9.1zm0 0"
                              fill="rgb(16.078431%,34.117647%,58.431373%)"
                            />
                          </svg>
                        </div>
                    ...
                    <a href="#">
                      <div className="box_top">
                        <div className="top_icon">
                          ...
                          >
                            <path
                              d="M17.676 34.344h9.55c2.476 0 3.375-.258 4.28-.742a5.04 5.04 0 0 0 2.097-2.102c.495-.902.743-1.8.743-4.277v-9.547H44.82c1.8 0 2.453.187 3.114.54.656.355 1.175.87 1.527 1.527s.54 1.31.54 3.113V44.82c0 1.8-.187 2.453-.54 3.114-.35.656-.87 1.175-1.526 1.527S46.62 50 44.82 50h32.855c-1.8 0-2.453-.187-3.113-.54s-1.172-.87-1.527-1.526-.54-1.312-.54-3.113zm0 0"
                              fillRule="evenodd"
                              fill="rgb(100%,46.27451%,31.764706%)"
                            />
                            <path
                      ...
                      <div className="box_top">
                        <div className="top_icon">
                          ...
                          >
                            ...
                            <path
                              d="M24 22.985c-.523 0-.954.396-1.01.905l-.006.11v52c0 .523.396.954.905 1.01l.11.006h52c.523 0 .954-.396 1.01-.905l.006-.11V42.302c0-.56-.455-1.015-1.015-1.015-.523 0-.954.396-1.01.905l-.006.11v32.682h-49.97v-49.97h34.7c.523 0 .954-.396 1.01-.905l.006-.11c0-.523-.396-.954-.905-1.01l-.11-.006h34z"
                              fill="#fff"
                              fillRule="nonzero"
                            />
                            <g fill="#eadae4">
                      ...
                      <div className="box_top">
                        <div className="top_icon">
                          ...
                          >
                            ...
                            <g fillRule="evenodd">
                              <path
                                d="M5.184 0h31.988c1.8 0 2.453.188 3.113.54.652.344 1.184.88 1.527 1.53.352.656.54 1.313.54 3.113v21.984c0 1.805-.187 2.457-.54 3.117-.344.648-.875 1.184-1.527 1.527-.66.352-1.312.54-3.113.54H5.184c-1.8 0-2.457-.187-3.113-.54-.652-.344-1.184-.88-1.527-1.527C.188 29.625 0 28.973 0 27.168V5.184c0-1.8.188-2.457.54-3.113.344-.652.88-1.184 1.53-1.53S3.383 0 5.184 0zm0 0"
                                fill="rgb(83.921569%,74.901961%,17.647059%)"
                              />
                              <path
                                d="M10.28 12.945v4.688c0 1.66-.926 2.66-2.707 2.66C5.406 20.293 5 18.852 5 18.07c0-.668.31-1.098.86-1.098.648 0 .813.504.813 1.05 0 .516.242.89.88.89.594 0 .926-.44.926-1.3V12.95c0-.54.352-.898.902-.898s.902.36.902.898zm1.672 6.402v-6.102c0-.8.418-1.055 1.055-1.055h3.762c1.516 0 2.738.75 2.738 2.508 0 1.44-1 2.508-2.75 2.508h-2v2.152c0 .54-.355.902-.902.902s-.902-.363-.902-.902zm1.805-5.773v2.242h1.68c.727 0 1.266-.437 1.266-1.12 0-.793-.56-1.12-1.45-1.12zm13.285 3.1v2.984c0 .332-.254.602-.613.602-.52 0-.66-.32-.773-1.023-.516.648-1.23 1.066-2.352 1.066-2.793 0-3.863-1.926-3.863-4.145 0-2.676 1.672-4.148 4.125-4.148 2.004 0 3.07 1.2 3.07 1.902 0 .63-.46.793-.848.793-.89 0-.56-1.242-2.32-1.242-1.242 0-2.223.813-2.223 2.816 0 1.56.77 2.637 2.246 2.637.957 0 1.793-.648 1.88-1.617h34.2c-.383 0-.812-.14-.812-.69 0-.44.254-.69.703-.69h3.223c.527 0 .738.262.738.758zm0 0"
                                fill="rgb(100%,100%,100%)"
                              />
                            </g>
                          </svg>
                        ...
                        <div className="top_icon">
                          ...
                          >
                            <g fill="none">
                              ...
                              />
                              <g
                                transform="translate(-371 -2828)translate(371 2828)translate(50.5 50.5)rotate(30)"
                                fill="#FFF"
                              >
                                <path d="M-16.2 3.8L-2.3 29.5C-2.1 29.7-1.9 29.8-1.7 29.7 -1.5 29.6-1.4 29.5-1.4 29.3L-1.4 10.6C-3.8 10-5.5 7.9-5.5 5.4 -5.5 2.5-3.1 0.1-0.2 0.1 2.8 0.1 5.2 2.5 5.2 5.4 5.2 7.9 3.4 10 1 10.6L1 29.3C1 29.5 1.2 29.7 1.5 29.7 1.6 29.7 1.8 29.6 1.9 29.5L15.8 3.8C16.2 3 16.2 2.2 15.9 1.4L8.4-15.1C8-16.1 7.1-16.7 6-16.7L-6.4-16.7C-7.5-16.7-8.4-16.1-8.9-15.1L-16.3 1.4C-16.6 2.2-16.6 3-16.2 3.8Z"></path>
                                <path d="M9-18.7L-9.4-18.7C-10.3-18.7-11.1-19.7-11.1-20.9L-11.1-28.3C-11.1-29.5-10.3-30.5-9.4-30.5L9-30.5C10-30.5 10.8-29.5 10.8-28.3L10.8-20.9C10.8-19.7 10-18.7 9-18.7Z"></path>
                              </g>
                            </g>
                          </svg>
                        </div>
                          ...
                          >
                            ...
                            <g fill="#FFF">
                              <path
                                ...
                                fillRule="nonzero"
                              />
                              <path d="M24.282 21c-.427 0-.78-.354-.78-.78V9.28c0-.427.354-.78.78-.78.208 0 .403.085.55.232l5.47 5.47c.146.146.232.342.232.55s-.085.403-.232.55l-5.47 5.47c-.146.146-.342.232-.55.232z"></path>
                            </g>
                          </svg>
                        </div>
                        <h3>Rotate PDF</h3>
                      ...
                      <div className="box_top">
                        <div className="top_icon">
                          ...
                          >
                            <defs>
                              <path
                                d="M22 28.172l9.074 9.146c.67.675 1.755.675 2.424 0a1.74 1.74 0 0 0 0-2.444L23.212 24.506c-.67-.675-1.755-.675-2.424 0L10.502 34.874a1.74 1.74 0 0 0 0 2.444c.67.675 1.755.675 2.424 0L22 28.172z"
                                id="A"
                              />
                              <path
                                d="M22 71.668l9.074-9.146c.67-.675 1.755-.675 2.424 0a1.74 1.74 0 0 1 0 2.444L23.212 75.334c-.67.675-1.755.675-2.424 0L10.502 64.966a1.74 1.74 0 0 1 0-2.444c.67-.675 1.755-.675 2.424 0L22 71.668z"
                                id="B"
                              />
                            </defs>
                            <path
                              d="M63.05 56h39.9c2.452 0 3.34.255 4.237.735s1.6 1.183 2.08 2.08S100 60.6 100 63.05v29.9c0 2.452-.255 3.34-.735 4.237s-1.183 1.6-2.08 2.08S95.4 100 92.95 100h-29.9c-2.452 0-3.34-.255-4.237-.735s-1.6-1.183-2.08-2.08S56 95.4 56 92.95v-29.9c0-2.452.255-3.34.735-4.237s1.183-1.6 2.08-2.08S60.6 56 63.05 56z"
                              fill="#f5c5b3"
                            />
                            <path
                              d="M7.05 0h39.9c2.452 0 3.34.255 4.237.735s1.6 1.183 2.08 2.08S44 4.6 44 7.05v85.9c0 2.452-.255 3.34-.735 4.237s-1.183 1.6-2.08 2.08S39.4 100 36.95 100H7.05c-2.452 0-3.34-.255-4.237-.735s-1.6-1.183-2.08-2.08S0 95.4 0 92.95V7.05C0 4.6.255 3.7.735 2.814s1.183-1.6 2.08-2.08S4.6 0 7.05 0z"
                              fill="#ee6c4d"
                            />
                            <path
                              d="M63.05 0h39.9c2.452 0 3.34.255 4.237.735s1.6 1.183 2.08 2.08S100 4.6 100 7.05v29.9c0 2.452-.255 3.34-.735 4.237s-1.183 1.6-2.08 2.08S95.4 44 92.95 44h-29.9c-2.452 0-3.34-.255-4.237-.735s-1.6-1.183-2.08-2.08S56 39.4 56 36.95V7.05c0-2.452.255-3.34.735-4.237s1.183-1.6 2.08-2.08S60.6 0 63.05 0z"
                              fill="#f5c5b3"
                            />
                            <path
                              d="M70.394 27.743l5.227-13.536c.345-.893.986-1.206 1.972-1.206h.96c.912 0 1.726.217 2.17 1.448l4.88 13.295c.148.386.394 1.086.394 1.52 0 .965-.863 1.737-1.898 1.737-.888 0-1.53-.314-1.824-1.086L81.24 27.02h-6.508l-1.06 2.895c-.27.772-.838 1.086-1.8 1.086-1.1 0-1.874-.676-1.874-1.737 0-.434.247-1.134.394-1.52zm9.96-3.475l-2.293-6.973h-.05l-2.4 6.973h4.733zM71 83.733V71.267c0-1.724.884-2.267 2.233-2.267h5.07c2.8 0 6.116.638 6.116 4.392a3.62 3.62 0 0 1-2.349 3.447v.047c1.767.472 2.93 1.747 2.93 4.085 0 3.565-2.86 5.03-6.163 5.03h-5.605C71.884 86 71 85.457 71 83.733zm3.814-5.3v4.58h3.2c1.488 0 3.163-.307 3.163-2.267 0-2.054-1.767-2.314-3.628-2.314h-2.744zm0-6.6v4.156h3.14c1.8 0 2.65-.732 2.65-2.078 0-1.63-1.35-2.078-2.767-2.078h-3.023z"
                              fill="#b63c23"
                            />
                            <g fill="#fff">
                              <mask>
                        ...
                        <div className="top_icon">
                          ...
                          >
                            ...
                            <path
                              fillRule="evenodd"
                              clipRule="evenodd"
                              d="M19.219 28.594c0-.431.35-.781.781-.781h10.435a.781.781 0 1 1 0 1.563h30a.781.781 0 0 1-.781-.782ZM19.219 32.072c0-.431.35-.781.781-.781h10.435a.781.781 0 0 1 0 1.562h30a.781.781 0 0 1-.781-.78Z"
                              fill="#FBE8E2"
                            />
                            <path
                              fillRule="evenodd"
                              clipRule="evenodd"
                              d="M9.375 24.61c0-.648.525-1.172 1.172-1.172h38.906a1.172 1.172 0 0 1 0 2.343H10.547a1.172 1.172 0 0 1-1.172-1.172Z"
                              fill="#fff"
                            />
                            <path
                              fillRule="evenodd"
                              clipRule="evenodd"
                              d="M8.28 24.609a2.266 2.266 0 0 1 2.266-2.266h38.907a2.266 2.266 0 1 1 0 4.532H10.546a2.266 2.266 0 0 1-2.265-2.266Zm2.266-1.172a1.172 1.172 0 0 0 0 2.344h38.907a1.172 1.172 0 0 0 0-2.344H10.546Z"
                              fill="#EE6C4D"
                            />
                          </svg>
                        </div>
                        ...
                        <div className="top_icon">
                          ...
                          >
                            ...
                            <path
                              fillRule="evenodd"
                              clipRule="evenodd"
                              d="M12.5 40.5v-18H14v18h-1.5Z"
                              fill="#fff"
                            />
                            <path
                              fillRule="evenodd"
                              clipRule="evenodd"
                              d="M12.5 37.5v-12H14v12h-1.5Z"
                              fill="#8FBC5D"
                            />
                            <path
                              fillRule="evenodd"
                            ...
                            />
                            <path
                              d="m26 7.5 5 5 4 5h-6.5A2.5 2.5 0 0 1 26 15V7.5Z"
                              fill="#E5F5D2"
                            />
                          </svg>
                        </div>
                        ...
                        <div className="top_icon">
                          ...
                          >
                            ...
                            <path
                              fill="#E8EDF3"
                              fillRule="evenodd"
                              d="M27 36.417h11a.5.5 0 0 0 .5-.5v-22a.5.5 0 0 0-.5-.5h37a.5.5 0 0 0-.5.5v22a.5.5 0 0 0 .5.5Zm11 1.5a2 2 0 0 0 2-2v-22a2 2 0 0 0-2-2h37a2 2 0 0 0-2 2v22a2 2 0 0 0 2 2h11Z"
                              clipRule="evenodd"
                            />
                            <path
                              fill="#E8EDF3"
                        ...
                        <div className="top_icon">
                          ...
                          >
                            ...
                            <path
                              fill="#E8EDF3"
                              fillRule="evenodd"
                              d="M11.5 10.918a1.5 1.5 0 0 1 1.5-1.5h32a1.5 1.5 0 0 1 0 3H13a1.5 1.5 0 0 1-1.5-1.5Z"
                              clipRule="evenodd"
                            />
                            <path
                              fill="#fff"
                              d="M12 18.102a2 2 0 0 1 2-2h30a2 2 0 0 1 2 2v7.615a2 2 0 0 1-2 2H14a2 2 0 0 1-2-2v-7.614Z"
                            />
                            <path
                              fill="#4A7AAB"
                              fillRule="evenodd"
                            ...
                            <path
                              fill="#E8EDF3"
                              fillRule="evenodd"
                              d="M11.5 32.917a1.5 1.5 0 0 1 1.5-1.5h31a1.5 1.5 0 0 1 0 3H13a1.5 1.5 0 0 1-1.5-1.5ZM11.5 38.917a1.5 1.5 0 0 1 1.5-1.5h11a1.5 1.5 0 0 1 0 3H13a1.5 1.5 0 0 1-1.5-1.5Z"
                              clipRule="evenodd"
                            />
                          </svg>
                        </div>
